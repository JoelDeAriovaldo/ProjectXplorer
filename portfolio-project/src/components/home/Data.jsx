  ...
  return (
    <div>
      <div className="home__data">
        <h1 className="home__title">Joel De Ariovaldo
            <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <h3 className="hume__subtitle">Full Stack Developer</h3>
        <p className="home__description">Sou um Desenvolvedor criativo baseado na Cidade da Beira, e sou muito apaixonado e dedicado ao meu trabalho.</p>
