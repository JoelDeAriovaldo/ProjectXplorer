        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <a href="Jproariovald@gmail.com" className="contact__button">
                Me Escreva {"."} <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
            ...
            <div className="contact__card  ">
              ...
              <span className="contact__card-data">+258846197987</span>

              <a href="https://api.whatsapp.com/send?phone=258846197987&text=Ola, mais informacoes!" className="contact__button">
                Me Escreva {"."} <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
